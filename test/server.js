    ...
    function(err, connection) {
        ...
        connection.execute(
            ...
            function(err, result) {
                ...
                if (result.rows.indexOf('tcps') > -1) {
                    console.log("Passed test. Network protocol is TCPS: " + result.rows);
                    //process.exit(0);
                } else {
                    console.log("Failed test. Network protocol is not TCPS: " + result.rows);
                    //process.exit(1);
                }
